...
df_old = pd.read_csv(r'data/ZypInstagram_Audience-CanadianCity.csv', index_col=False,encoding="utf-8");
...
df_cityNames = pd.read_csv(r'CanadianCities-Adjusted.csv');
cityNames = [];
...
df.to_csv("data/ZypInstagram_Audience-CanadianCity.csv",index=False,encoding="utf-8");
...
googleSheetName = "ZypInstagram_Audience-CanadianCity";
spreadsheetID = "1hak1dLB8lDvZ5ofEdzahoA5Q0nX3uiH_2lAhpbFPMeg";
csvFilePath = "data/ZypInstagram_Audience-CanadianCity.csv";
