...
df_old = pd.read_csv(r'data/ZypFacebook_Audience-CanadianCity2.csv', index_col=False, encoding='utf8');
...
df.to_csv("data/ZypFacebook_Audience-CanadianCity2.csv", index=False, encoding='utf8')
...
googleSheetName = "ZypFacebook_Audience-CanadianCity2";
spreadsheetID = "1aLL8A-CccdqJAm0Zrzy0rQJvfDCHAWXCGECjO6xm5Nw";
csvFilePath = "data/ZypFacebook_Audience-CanadianCity2.csv";
