...
df_old = pd.read_csv(r'data/ZypFacebook_Insights2.csv', index_col=False);
...
results = req_facebook("zypgallery/insights?metric=page_fans_online_per_day&period=day&since=" + str(sinceDate)).json();

metrics = ["end_time","page_fans_online_per_day"];
...
df.to_csv("data/ZypFacebook_Insights2.csv",index=False);
...
googleSheetName = "ZypFacebook_Insights2";
spreadsheetID = "1KFay_x4TX47vKmw3vrnpWmkcMEsPHsutgTeYvPmUOFA";
csvFilePath = "data/ZypFacebook_Insights2.csv";
