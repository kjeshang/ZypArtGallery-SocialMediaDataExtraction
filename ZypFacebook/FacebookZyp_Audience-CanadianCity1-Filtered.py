...
df_old = pd.read_csv(r'data/ZypFacebook_Audience-CanadianCity1-Filtered.csv', index_col=False, encoding='utf8');
...
df.to_csv("data/ZypFacebook_Audience-CanadianCity1-Filtered.csv", index=False, encoding='utf8')
# df_temp.to_csv("data/ZypFacebook_Audience-CanadianCity1-Filtered.csv", index=False, encoding='utf8')
...
googleSheetName = "ZypFacebook_Audience-CanadianCity1-Filtered";
spreadsheetID = "1JIzIbdg1gVR1-P4cfL-ZLZzOgxWJb4Iq0qympT16ZUE";
csvFilePath = "data/ZypFacebook_Audience-CanadianCity1-Filtered.csv";
