...
df_old = pd.read_csv(r'data/ZypFacebook_Audience-Age&Gender1.csv', index_col=False);
...
results = req_facebook("zypgallery/insights?metric=page_fans_gender_age&period=day&since=" + str(sinceDate)).json();
...
df.to_csv("data/ZypFacebook_Audience-Age&Gender1.csv",index=False);
...
googleSheetName = "ZypFacebook_Audience-Age&Gender1";
spreadsheetID = "1_zm-IfS3nixl43rWtfuZk5aJb5JA47EaxcRd57tS66Q";
csvFilePath = "data/ZypFacebook_Audience-Age&Gender1.csv";
