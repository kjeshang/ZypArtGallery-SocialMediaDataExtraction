...
df_old = pd.read_csv(r'data/ZypFacebook_Audience-Country1.csv', index_col=False, encoding='utf-8');
...
results = req_facebook("zypgallery/insights?metric=page_fans_country&period=day&since=" + str(sinceDate)).json();
...
df.to_csv("data/ZypFacebook_Audience-Country1.csv", index=False, encoding='utf-8');
...
googleSheetName = "ZypFacebook_Audience-Country1";
spreadsheetID = "1KzktfyYEg2ckv6yycVMKPT8YXmlCNcsTDqfyS30Eu_s";
csvFilePath = "data/ZypFacebook_Audience-Country1.csv";
